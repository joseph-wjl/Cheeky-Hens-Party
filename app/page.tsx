...
• Unique memories and masterpieces! Walk away with drawings, stories, and laughs.`,
  ...
  return (
    <>
        ...
        <div className="relative z-10 max-w-4l w-full lg:pl-20">
          <Reveal>
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl lg:text-left font-bold mb-4 text-white">
              The First and Only
              <br />Hen Party Life Drawing Experience
              <br />in Hong Kong
            </h2>
          </Reveal>
        ...
        <div className="max-w-5xl">
          <Reveal>
            <h2 className="text-3xl sm:text-4xl font-bold mb-2">
              Hen Party Booking Process
            </h2>
          </Reveal>

          <Reveal delay={100}>
            <h2 className="text-2xl sm:text-3xl font-bold italic mb-6 sm:mb-10">
              Step-by-Step Guide
            </h2>
          </Reveal>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {[...Array(9)].map((_, i) => (
              <Reveal key={i} delay={i * 80}>
                <div className="w-full aspect-square overflow-hidden shadow-sm">
                  <img
      ...
      {/* Review Section */}
      <section id="reviews" className="text-black py-20 text-center bg-white relative">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-start py-8">
            {[
              ...
              <Reveal key={i} delay={i * 150}>
                <div className="flex flex-col bg-[#FEEFEC] w-full sm:w-[300px] h-auto sm:h-[500px] p-6 sm:p-8">
      ...
      <div className="relative w-full -mt-42 sm:-mt-42 lg:-mt-42">
        <Reveal>
          <img src="/images/banana.png" alt="a hand holding a banana" className="w-80" />
        </Reveal>
      </div>
      ...
      <section id="questions" className="text-center bg-[#FEEFEC] pb-10 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-4 text-left">
            {questions.map((qa, i) => (
              <Reveal key={i} delay={i * 80}>
                <div className="border-b border-[#e4b9ae] pb-4">
                  <button
                    onClick={() => toggle(i)}
